...
/**
 * Created by Administrator姜军 on 2018/3/22.
 */
...
//        }
    ...
    public static void setStatus(Context context,View view){
        ...
        mlp.setMargins(mlp.leftMargin, mlp.topMargin + StatusBarUtil.getStatusBarHeight(context),
                mlp.rightMargin, mlp.bottomMargin);
    }


    public static void setHeadHighly(Context context,View view){
