package com.jiangjun.library.download.service;
...
import com.jiangjun.library.download.DownloadStatus;
import com.jiangjun.library.download.FileInfo;
import com.jiangjun.library.download.bean.DownloadInfo;
import com.jiangjun.library.download.bean.RequestInfo;
import com.jiangjun.library.download.config.InnerConstant;
import com.jiangjun.library.download.db.DbHolder;
import com.jiangjun.library.download.execute.DownloadExecutor;
import com.jiangjun.library.download.execute.DownloadTask;
import com.jiangjun.library.download.utils.LogUtils;
