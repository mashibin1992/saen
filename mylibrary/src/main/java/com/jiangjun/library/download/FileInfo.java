package com.jiangjun.library.download;

import android.graphics.Color;

import androidx.annotation.IntRange;

import com.jiangjun.library.download.utils.DebugUtils;
...
public class FileInfo implements Serializable {
    ...
    public static int textColor2 = Color.parseColor("#666666");
    public static int textColor3 = Color.parseColor("#999999");
    public static int textColorBlock = Color.parseColor("#000000");
    public static int textColorRandarRed = Color.parseColor("#FF0000");
    public static int textColorGreen = Color.parseColor("#46BCFF");
