...
package com.jiangjun.library.citypicker.citypickerview.widget.wheel;
...
import com.jiangjun.library.citypicker.citypickerview.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    protected void notifyChangingListeners(int oldValue, int newValue) {
        ...
        Log.e("notifyChangingListeners", "" + getScrollY());
