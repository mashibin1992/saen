package com.jiangjun.library.citypicker.citypickerview;
...
import com.jiangjun.library.citypicker.citypickerview.widget.CanShow;
import com.jiangjun.library.citypicker.citypickerview.widget.wheel.OnWheelChangedListener;
import com.jiangjun.library.citypicker.citypickerview.widget.wheel.WheelView;
import com.jiangjun.library.citypicker.citypickerview.widget.wheel.adapters.ArrayWheelAdapter;
import com.jiangjun.library.citypicker.citywheel.CityConfig;
import com.jiangjun.library.citypicker.citywheel.CityParseHelper;
...
public class CityPickerView implements CanShow, OnWheelChangedListener {
    ...
    private void updateAreas() {
        ...
        if (config.getWheelType() == CityConfig.WheelType.PRO_CITY
            ...
            if (parseHelper.getPro_CityMap().get(parseHelper.getProvinceBean().getName()).length == 0) {
                return;
            }
    ...
    public void onChanged(WheelView wheel, int oldValue, int newValue) {
        if (wheel == mViewProvince) {
            ...
            if (parseHelper != null && parseHelper.getCity_DisMap() != null) {
                if (parseHelper.getCity_DisMap().get(parseHelper.getProvinceBean().getName() + parseHelper.getCityBean().getName()) != null) {
                    if (parseHelper.getCity_DisMap()
                            .get(parseHelper.getProvinceBean().getName() + parseHelper.getCityBean().getName()).length > 0) {
