...
public class MyBaseSubscriber2<T> extends BaseSubscriber<ResponseBody> {

//    private NovateUtils.setRequestReturn<T> callBack;
    private NovateUtils.setResponseBody<String> callBack;
    private String url;
    ...
    public MyBaseSubscriber2(Context context, String url, boolean isShow, NovateUtils.setResponseBody<String> callBack) {
        super(context);
    ...
    private static class MyHandler extends Handler {
        WeakReference<MyBaseSubscriber2> weakReference;
        public LoadingDialog progress;
        private Context context;

        public MyHandler(MyBaseSubscriber2 activity, Context context) {
            try {
