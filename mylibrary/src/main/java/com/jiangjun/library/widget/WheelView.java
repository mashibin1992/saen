...
public class WheelView extends View {
    ...
    private void initData() {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            itemObject.id = i;
            itemObject.itemText = dataList.get(i).getName();
            itemObject.bean = dataList.get(i).getBean();
            itemObject.x = 0;
     ...
     * @param data
     */
    public void refreshData(ArrayList<DataBean> data) {
        setData(data);
        invalidate();
    }
    ...
    public static class DataBean{
        ...
        public DataBean(String name, Object bean) {
            this.name = name;
            this.bean = bean;
        }
        ...
        public DataBean setBean(Object bean) {
            this.bean = bean;
            return this;
        }
    }
