package com.jiangjun.library.widget.timeselector;
...
import com.jiangjun.library.widget.timeselector.Utils.ScreenUtil;
import com.jiangjun.library.widget.timeselector.Utils.TextUtil;
import com.jiangjun.library.widget.timeselector.view.PickerView;
...
public class TimeSelector {
     ...
     * @param context
     * @param resultHandler
     * @param startDate     开始时间    1980-01-01 00:00
     * @param endDate       结束时间    2030-01-01 00:00
     * @param workStartTime 早上几点开始 9：00
     * @param workEndTime   晚上几点结束 15:00
     */
    ...
    public void setDefaultCurrentTime() {
        try {
            ...
            if (spanYear) {
                year_pv.setSelected(StringUtil.getTimeItem("yyyy"));
                month.clear();
                ...
                month_pv.setSelected(StringUtil.getTimeItem("MM"));
                ...
                day_pv.setData(day);
                day_pv.setSelected(StringUtil.getTimeItem("dd"));
                ...
                if ((scrollUnits & SCROLLTYPE.HOUR.value) == SCROLLTYPE.HOUR.value) {
                    ...
                    hour_pv.setSelected(StringUtil.getTimeItem("HH"));
                }
                ...
                if ((scrollUnits & SCROLLTYPE.MINUTE.value) == SCROLLTYPE.MINUTE.value) {
                    ...
                    minute_pv.setSelected(StringUtil.getTimeItem("mm"));
                ...
                if ((scrollUnits & SCROLLTYPE.HOUR.value) == SCROLLTYPE.HOUR.value) {
                    ...
                    if (selectedMonth == startMonth && selectedDay == startDay) {
                        for (int i = startHour; i <= MAXHOUR; i++) {
                            hour.add(fomatTimeUnit(i));
                        }
                ...
                if ((scrollUnits & SCROLLTYPE.MINUTE.value) == SCROLLTYPE.MINUTE.value) {
                    ...
                    if (selectedMonth == startMonth && selectedDay == startDay && selectedHour == startHour) {
                        for (int i = startMininute; i <= MAXMINUTE; i++) {
                            minute.add(fomatTimeUnit(i));
                        }
                    } else if (selectedMonth == endMonth && selectedDay == endDay && selectedHour == endHour) {
                        for (int i = MINMINUTE; i <= endMininute; i++) {
                            minute.add(fomatTimeUnit(i));
                        }
                    } else if (selectedHour == hour_workStart) {
                ...
                if ((scrollUnits & SCROLLTYPE.MINUTE.value) == SCROLLTYPE.MINUTE.value) {
                    ...
                    if (selectedDay == startDay && selectedHour == startHour) {
                        for (int i = startMininute; i <= MAXMINUTE; i++) {
                            minute.add(fomatTimeUnit(i));
                        }
                    } else if (selectedDay == endDay && selectedHour == endHour) {
                        for (int i = MINMINUTE; i <= endMininute; i++) {
                            minute.add(fomatTimeUnit(i));
                        }
                    } else if (selectedHour == hour_workStart) {
