...
public class AchievementCurveView extends View {
    ...
    public AchievementCurveView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected void onDraw(Canvas canvas) {
        mPaint.setColor(res.getColor(R.color.color_26416180));
        drawAllXLine(canvas);
        // 画直线（纵向）
        drawAllYLine(canvas);
        // 点的操作设置
        mPoints = getPoints();
        mPaint.setColor(res.getColor(R.color.color_5D7DFF));
