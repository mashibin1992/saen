...
public class PageView extends HorizontalScrollView {
    ...
    public void addPage(View page, int index) {
        ...
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(mScreenWidth, ViewGroup.LayoutParams.WRAP_CONTENT);
        if(index == -1) {
    ...
    public void setSelectListener(OnSelectPageListener onSelectPageListener ){
