...
public class SearchResultWendaAdapter extends BaseQuickAdapter<SearchWenDaBean.DataBean, BaseViewHolder> {
    ...
    public SearchResultWendaAdapter(int layoutResId, @Nullable List<SearchWenDaBean.DataBean>data, Context context) {
    ...
    @Override
    protected void convert(@NotNull BaseViewHolder baseViewHolder,SearchWenDaBean.DataBean dataBean ) {
