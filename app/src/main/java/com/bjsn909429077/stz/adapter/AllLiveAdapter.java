...
public class AllLiveAdapter extends BaseQuickAdapter<AllLiveListBean.DataBean, BaseViewHolder> {
    ...
    public AllLiveAdapter(int layout, ArrayList<AllLiveListBean.DataBean> strings, BaseLazyLoadFragment noteFragment) {
