 ...
 * @Date :2021/9/6 17:32
 **/
public class MyWDAdapter extends BaseQuickAdapter<WdListBean.DataBean, BaseViewHolder> {
    ...
    public MyWDAdapter(int layoutResId, @Nullable List<WdListBean.DataBean>data, Context context,String types) {
