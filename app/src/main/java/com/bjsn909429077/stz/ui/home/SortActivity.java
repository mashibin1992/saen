...
public class SortActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initData() {
        ...
        map.put("typeId", 0);
        NovateUtils.getInstance().Post(mContext, BaseUrl.fnLeiyj, map, true,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_sort_btn:
                if (intent != null) {
                    SharedPreferencesUtil.saveData(mContext, "one", intent.getIntExtra("id", -1));
                    SharedPreferencesUtil.saveData(mContext, "titleOne", intent.getStringExtra("title"));
                    //请选择辅导
