...
public class AlreadyPayOrderFragment extends BaseLazyLoadFragment {
    ...
    @Override
    protected void init() {
        already_pay_order_rv = (RecyclerView) findViewById(R.id.already_pay_order_rv);
    }
    ...
    protected void loadData() {
        ...
        map.put("page", 0);
        map.put("type", 2);//类型：0、全部 1、待支付 2、已支付；默认全部
                ...
                new NovateUtils.setRequestReturn<AllOrderBean>() {
                    ...
                    public void onSuccee(AllOrderBean response) {
                        if (response != null && response.getData() != null) {
                            ...
                            already_pay_order_rv.setLayoutManager(linearLayoutManager);
                            already_pay_order_rv.setAdapter(allOrderAdapter);
                        }
                    }
                });
    }
