 ...
 * @Author: Ke.Chen
 * @Description:
 * @Date :2021/9/20 08:52
 **/
public class AllOrderFragment extends BaseLazyLoadFragment {
    ...
    @Override
    protected void init() {
        all_order_rv = (RecyclerView) findViewById(R.id.all_order_rv);
    }
    ...
    protected void loadData() {
        ...
        map.put("page", 0);
        map.put("type", 0);//类型：0、全部 1、待支付 2、已支付；默认全部
                ...
                new NovateUtils.setRequestReturn<AllOrderBean>() {
                    ...
                    public void onSuccee(AllOrderBean response) {
                        if (response != null && response.getData() != null) {
                            ...
                            all_order_rv.setLayoutManager(linearLayoutManager);
                            all_order_rv.setAdapter(allOrderAdapter);
                        }
                    }
                });
    }
