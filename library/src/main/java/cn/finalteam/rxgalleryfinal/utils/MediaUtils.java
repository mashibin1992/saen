...
public class MediaUtils {
    ...
    public static Bundle createSqlQueryBundle(
        ...
        queryArgs.putString("android:query-arg-sql-limit",  limit + " offset " + offset);
        return queryArgs;
    }
    ...
    public static List<MediaBean> getMediaWithImageList(Context context, String bucketId, int page, int limit) {
        ...
        if (android.os.Build.VERSION.SDK_INT > Build.VERSION_CODES.Q) {
            cursor = contentResolver.query(
                    ...
                    createSqlQueryBundle(selection, selectionArgs, MediaStore.Images.Media.DATE_ADDED, limit + "", offset + ""),
                    null);
        }else {
            cursor = contentResolver.query(
                    uri,
    ...
    public static List<MediaBean> getMediaWithVideoList(Context context, String bucketId, int page, int limit) {
        ...
        if (android.os.Build.VERSION.SDK_INT > Build.VERSION_CODES.Q) {
            cursor = contentResolver.query(
                    uri,
                    projection.toArray(new String[projection.size()]),
                    createSqlQueryBundle(selection, selectionArgs, MediaStore.Video.Media.DATE_ADDED, limit + "", offset + ""),
                    null);
        }else {
            cursor = contentResolver.query(
                    uri,
